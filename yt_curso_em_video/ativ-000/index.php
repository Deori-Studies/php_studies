...
<body>
  ...
  <main>
    <section>
      ...
      <p>
        Em resumo, as aspas simples são úteis quando você tem uma string literal 
        e não precisa de nenhuma interpretação ou substituição de variáveis. 
        As aspas duplas são úteis quando você precisa incluir variáveis em uma 
